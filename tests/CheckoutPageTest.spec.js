...
test("Validate multiple items checkout functionality by providing all valid details in checkout page", {tag:'@pom1'}, async ()=>{
...
test("Validate single item checkout functionality by providing all valid details in checkout page", {tag:'@pom1'}, async ()=>{
...
test("Validate checkout functionality without providing any details in checkout page", {tag:'@pom1'}, async ()=>{
...
test("Validate checkout functionality without providing country in checkout page", {tag:'@pom1'}, async ()=>{
...
test("Validate checkout functionality without providing email id in checkout page", {tag:'@pom1'}, async ()=>{
    await dashboardPage.searchProductAndAddToCart(productNameZaraCoat)
    await expect(dashboardPage.addToCartSuccessMessage).toHaveText("Product Added To Cart")
    await dashboardPage.navigateToCartPage()
    await expect(cartPage.productsInCart).toHaveCount(1)
...
test("Validate checkout functionality without providing any details in Personal Information section in checkout page", {tag:'@pom1'}, async ()=>{
    await dashboardPage.searchProductAndAddToCart(productNameAdidas)
    await expect(dashboardPage.addToCartSuccessMessage).toHaveText("Product Added To Cart")
    await dashboardPage.navigateToCartPage()
    await expect(cartPage.productsInCart).toHaveCount(1)
...
test("Validate checkout functionality without providing any details in Shipping Information section in checkout page", {tag:'@pom1'}, async ()=>{
    await dashboardPage.searchProductAndAddToCart(productNameAdidas)
    await expect(dashboardPage.addToCartSuccessMessage).toHaveText("Product Added To Cart")
    await dashboardPage.navigateToCartPage()
    await expect(cartPage.productsInCart).toHaveCount(1)
...
test("Validate checkout functionality without providing any coupon and click on 'Apply Coupon' button in checkout page", {tag:'@pom1'}, async ()=>{
    await dashboardPage.searchProductAndAddToCart(productNameAdidas)
    await expect(dashboardPage.addToCartSuccessMessage).toHaveText("Product Added To Cart")
    await dashboardPage.navigateToCartPage()
    await expect(cartPage.productsInCart).toHaveCount(1)
...
test("Validate checkout functionality by providing invalid coupon and click on 'Apply Coupon' button in checkout page", {tag:'@pom1'}, async ()=>{
    await dashboardPage.searchProductAndAddToCart(productNameAdidas)
    await expect(dashboardPage.addToCartSuccessMessage).toHaveText("Product Added To Cart")
    await dashboardPage.navigateToCartPage()
    await expect(cartPage.productsInCart).toHaveCount(1)
...
test("Validate checkout functionality by providing invalid email id in checkout page", {tag:'@pom1'}, async ()=>{
    await dashboardPage.searchProductAndAddToCart(productNameZaraCoat)
    await expect(dashboardPage.addToCartSuccessMessage).toHaveText("Product Added To Cart")
    await dashboardPage.navigateToCartPage()
    await expect(cartPage.productsInCart).toHaveCount(1)
...
test("Validate checkout functionality by providing invalid country in checkout page", {tag:'@pom1'}, async ()=>{
    await dashboardPage.searchProductAndAddToCart(productNameZaraCoat)
    await expect(dashboardPage.addToCartSuccessMessage).toHaveText("Product Added To Cart")
    await dashboardPage.navigateToCartPage()
    await expect(cartPage.productsInCart).toHaveCount(1)
...
test("Validate selecting 'Paypal' payment type in checkout page", {tag:'@pom1'}, async ()=>{
    await dashboardPage.searchProductAndAddToCart(productNameZaraCoat)
    await expect(dashboardPage.addToCartSuccessMessage).toHaveText("Product Added To Cart")
    await dashboardPage.navigateToCartPage()
    await expect(cartPage.productsInCart).toHaveCount(1)
...
test("Validate selecting 'SEPA' payment type in checkout page", {tag:'@pom1'}, async ()=>{
    await dashboardPage.searchProductAndAddToCart(productNameZaraCoat)
    await expect(dashboardPage.addToCartSuccessMessage).toHaveText("Product Added To Cart")
    await dashboardPage.navigateToCartPage()
    await expect(cartPage.productsInCart).toHaveCount(1)
...
test("Validate selecting 'Invoice' payment type in checkout page", {tag:'@pom1'}, async ()=>{
    await dashboardPage.searchProductAndAddToCart(productNameZaraCoat)
    await expect(dashboardPage.addToCartSuccessMessage).toHaveText("Product Added To Cart")
    await dashboardPage.navigateToCartPage()
    await expect(cartPage.productsInCart).toHaveCount(1)
